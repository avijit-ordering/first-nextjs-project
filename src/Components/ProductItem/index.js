...
const ProductItem = (props) => {
    ...
    return (
        <>
            <div className={`productItem ${props.itemView}`} onClick={()=>context.handleLoading()} onMouseEnter={()=>handleMouseEnter(props?.itemView === 'recentlyView' ? props.item?.prodId : props.item?.id)}
                ...
                <div className="info">
                    ...
                    {
                        props?.item?.countInStock>=1 ?  <span className="text-success d-block">{context.useLanguage('IN_STOCK')}</span>
                        :
