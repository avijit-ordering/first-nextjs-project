...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        if (user && user?.userId) {
            ...
            const cart2 = JSON.parse(cart1);
            setCartData(cart2);
            setselectedQuantity(cart2?.quantity) 
    ...
    const selectedItem = (item, quantityVal) => {
        if (chengeQuantity !== 0) {
            ...
            /*start static code */
            cartFields.countInStock = 10;
            setCartData([cartFields]);
            context.setCartData([cartFields])
            /*end static code */
                                                    ...
                                                    cartData?.length !== 0 && cartData?.map((item, index) => {
                                                        return (
                                                            <tr>
                                                                ...
                                                                <td width="25%">
                                                                    <QuantityBox quantity={quantity} item={item} selectedItem={selectedItem} value={item?.quantity} setCartData={setCartData}/>
                                                                </td>
